...
2. Lies AGENTS.md, development/release-preflight.md und development/shared/luna-release-gate.md. Baue Standalone/general sowie die vollständigen Suite/general und Suite/codex mit development/build_suite.py unter E:/Dropbox/AI Projects/skills/temp/release/ nach Ende bestehender Leser; Task-temp hält Baseline-Kopien und Laufdaten. Prüfe aktuelle Pakete, Shared-Snapshot und isolierten Export. Pflege README-Änderungen in development/readme/scoville-ui. Führe betroffene Build-/Pakettests und die beauftragten Verständnisfälle gemäß ADR-0011 aus; der gestoppte PLAN-0002-Testlauf bleibt davon getrennt.
