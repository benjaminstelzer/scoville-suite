...
`origin/main` steht auf `c89641a6d73b0ecdfb32f057663261a4aa1dd972` und enthält den Workflow noch nicht; der lokale Stand ist 15 Commits voraus. Weil das Repository öffentlich ist, bleibt der erforderliche Push bis zum Abschluss von PLAN-0011 durch das Releasegate gesperrt.
