...
- Keep Deep research rigorous without requiring saved documents. Create and
  validate a durable package only when the user requests saved artifacts.
- Clarify combined Brainstorm evidence, implementation authorization, and the
  family rule for independently activated Skills.

## v1.1.8 - 2026-09-19

- Require an approved project-owned or temporary output path before writing a
  durable Deep Research package. Deep rigor no longer creates a workspace-root
  `research/` directory by default.
