...
17. Explicit consent authorizes that task's archive and verification. Report failed archival/still-visible state honestly; no deletion or unbounded replacement chain. Do not claim archived without verification.
...
25. Answer status inline and continue permitted delivery recovery in the same turn unless cancelled/replaced. SOL's truncated content is not a complete answer: request only missing findings through the same task, without reading its chat. Report Claude timeout, retained ID and uncertain interrupted-turn persistence; resume only on request. Do not claim complete or a successful partial answer before either lane supplies a complete answer. Preserve lane-specific settings/errors, no cross-feeding, replacement task, publication or inferred authority.
