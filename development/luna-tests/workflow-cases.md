...
12. A Step annotated route:low changes authorization semantics. It specifies an executor model but no effort. How are route, pair and review settings resolved?
...
21. An accepted committed Step has another eligible Step remaining. coordinator_percent is 33; fresh exact-own input_tokens is 33000 and model_context_window is 100000. What must happen before next selection? Contrast invalid configuration and stale telemetry.
