...
- `scoville-research`: source-backed landscape evidence and prior-art synthesis.
- `scoville-code-anti-ai-slop`: implementation scope, engineering risk, and validation after selection.
- `scoville-design-anti-ai-slop`: visual concept and art direction after selection.
