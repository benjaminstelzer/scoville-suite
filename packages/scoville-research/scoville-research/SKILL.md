...
- `scoville-brainstorm`: divergent mechanism generation and shortlist ownership.
- `scoville-code-anti-ai-slop`: implementation scope, engineering risk, and validation.
